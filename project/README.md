...
### 4.6. Запуск сервиса (API) через Docker
...
- Kaggle API token, если требуется заново загрузить датасет;
- доступ к интернету для автоматической загрузки весов модели из GitHub Releases.
