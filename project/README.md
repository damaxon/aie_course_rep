...
- **Название проекта:** Детекция и классификация транспортных средств
- **Автор:** Петрушинский Максим Геннадьевич
- **Группа:** БАСО-01-24
- **Контакт:** @damaxon

- **Краткое описание:**  
  > Проект посвящён построению сервиса для анализа дорожного трафика с классификацией транспорта по типам.
  > Может использоваться для систем умного города, анализа загруженности дорог.  
  > Используются открытые датасеты, предобученные модели CV.  
  > Результат – API, принимающий на вход изображение (кадр видео) и возвращающий полный список объектов с координатами bounding box и классификацией.
